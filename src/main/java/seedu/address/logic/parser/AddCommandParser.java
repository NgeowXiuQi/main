    ...
    public AddCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS,
                  PREFIX_SALARY, PREFIX_OTHOUR, PREFIX_OTRATE, PREFIX_DEDUCTIONS,
                  PREFIX_TAG);
        ...
        OtHour otHour = ParserUtil.parseOtHours(argMultimap.getValue(PREFIX_OTHOUR).get());
        OtRate otRate = ParserUtil.parseOtRate(argMultimap.getValue(PREFIX_OTRATE).get());
        PayDeductibles deductibles = ParserUtil.parseDeductibles(argMultimap.getValue(PREFIX_DEDUCTIONS).get());
