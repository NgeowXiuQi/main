...
import static seedu.address.logic.commands.CommandTestUtil.DEDUCTIBLES_DESC_AMY;
import static seedu.address.logic.commands.CommandTestUtil.DEDUCTIBLES_DESC_BOB;
...
import static seedu.address.logic.commands.CommandTestUtil.OTHOUR_DESC_AMY;
import static seedu.address.logic.commands.CommandTestUtil.OTHOUR_DESC_BOB;
import static seedu.address.logic.commands.CommandTestUtil.OTRATE_DESC_AMY;
import static seedu.address.logic.commands.CommandTestUtil.OTRATE_DESC_BOB;
...
public class AddCommandSystemTest extends AddressBookSystemTest {
    ...
    public void add() {
        ...
        String command = "   " + AddCommand.COMMAND_WORD + "  " + NAME_DESC_AMY + "  " + PHONE_DESC_AMY + " "
                ...
                + SALARY_DESC_AMY + "   " + OTHOUR_DESC_AMY + "   "
                + OTRATE_DESC_AMY + "   " + DEDUCTIBLES_DESC_AMY + "   "
          + TAG_DESC_FRIEND + " ";
        ...
        command = AddCommand.COMMAND_WORD + NAME_DESC_BOB + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + SALARY_DESC_AMY + OTHOUR_DESC_AMY + OTRATE_DESC_AMY + DEDUCTIBLES_DESC_AMY
                + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd);
        ...
        command = AddCommand.COMMAND_WORD + TAG_DESC_FRIEND + PHONE_DESC_BOB + ADDRESS_DESC_BOB + NAME_DESC_BOB
                + TAG_DESC_HUSBAND + EMAIL_DESC_BOB + SALARY_DESC_BOB + OTHOUR_DESC_BOB
                + OTRATE_DESC_BOB + DEDUCTIBLES_DESC_BOB;
        assertCommandSuccess(command, toAdd);
